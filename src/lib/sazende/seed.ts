...
export const seedCategories: SeedCategory[] = [
  {
    ...
    items: [
      ...
      { name: "Antep Usulü Beyran", price: 350 },
      ...
      { name: "Tavuk Suyu", price: 120 },
      { name: "Mercimek", price: 100 },
      { name: "Tereyağlı Mercimek", price: 120 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Urfa", price: 480 },
      { name: "Tavuk Şiş", price: 380 },
      { name: "Kanat", price: 380 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "B. Boy Kaşarlı Pide", price: 270 },
      { name: "B. Boy Kıymalı Pide", price: 350 },
      { name: "Sucuklu Pide", price: 350 },
      { name: "Sucuklu Kaşarlı Pide", price: 400 },
      { name: "Kuşbaşılı Pide", price: 350 },
      { name: "Kavurmalı Pide", price: 400 },
      { name: "Karışık Pide", price: 400 },
