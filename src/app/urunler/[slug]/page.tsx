    ...
    <main className="min-h-screen bg-[#f7f3ed] px-4 py-5 text-zinc-950 md:px-6">
      <div className="mx-auto max-w-7xl">
        <header className="sticky top-0 z-40 -mx-4 mb-6 flex items-center justify-between border-b border-zinc-200/70 bg-[#f7f3ed]/90 px-4 py-3 backdrop-blur-xl md:-mx-6 md:px-6">
          ...
          <Link href="/#urunler" className="inline-flex min-h-10 items-center gap-2 rounded-full border border-zinc-300 bg-white px-4 text-sm font-black">
            Ürünlere dön <ArrowIcon className="h-4 w-4 rotate-180" />
          </Link>
        </header>

        <section className="smooth-card grid gap-7 border border-white/80 bg-white/72 p-3 shadow-xl shadow-zinc-950/8 backdrop-blur md:p-6 lg:grid-cols-[1.05fr_0.95fr] lg:p-8">
          <ProductDetailGallery images={gallery} productName={product.name} primaryAlt={product.imageAlt} />
          <div className="flex flex-col justify-center px-1 pb-3 md:px-0 lg:sticky lg:top-24 lg:self-start">
            ...
            <p className="mt-5 text-xs font-bold uppercase tracking-[0.24em] text-zinc-500">{product.eyebrow}</p>
            <h1 className="mt-3 break-words text-5xl font-black tracking-[-0.075em] md:text-6xl xl:text-7xl">{product.name}</h1>
            <p className="mt-3 text-xl font-black tracking-[-0.03em] text-zinc-950">{product.hierarchy}</p>
            ...
            <div className="mt-6 rounded-[1.5rem] border border-zinc-200 bg-white p-4 shadow-sm">
              <div>
            ...
            <p className="mt-3 text-center text-xs font-bold text-zinc-500 sm:text-left">
              Sepete ekledikten sonra çoklu alım avantajı otomatik hesaplanır.
            </p>
            <div className="mt-5 rounded-[1.3rem] bg-zinc-950 p-4 text-white">
        ...
        <section className="mt-8 smooth-card border border-zinc-200 bg-white p-3 shadow-sm">
          <div className="grid gap-2 sm:grid-cols-4">
            ...
            <a href="#birlikte" className="rounded-full bg-[#f7f3ed] px-4 py-3 text-center text-sm font-black text-zinc-950">Birlikte ekle</a>
          </div>
        </section>

        <section id="aciklama" className="mt-8 grid scroll-mt-24 gap-5 md:grid-cols-[0.9fr_1.1fr]">
        ...
        <section id="yorum-etkisi" className="mt-8 scroll-mt-24">
        ...
        <section id="galeri" className="mt-8 scroll-mt-24">
        ...
        <section id="birlikte" className="mt-8 scroll-mt-24 pb-28 md:pb-16">
          <div className="smooth-card border border-zinc-200 bg-white p-5 shadow-sm md:p-6">
